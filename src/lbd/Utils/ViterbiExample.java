...
public class ViterbiExample {
    ...
    public static void main(String[] args) 
    {
		...
		Hashtable<String, Hashtable<String, Float>> transition_probability = new Hashtable<String, Hashtable<String, Float>>();
		...
		Hashtable<String, Hashtable<String, Float>> emission_probability = new Hashtable<String, Hashtable<String, Float>>();
		...
		Object[] ret = forward_viterbi(observations, states, start_probability,
