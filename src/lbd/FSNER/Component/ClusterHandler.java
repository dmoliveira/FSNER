...
public class ClusterHandler {
	...
	public void addSequence(ArrayList<Entity> entityList, SequenceLabel sequenceLabelProcessed) {
		
		String [] processedSequence = new String[sequenceLabelProcessed.size()];
		
		for(int i = 0; i < processedSequence.length; i++)
			processedSequence[i] = sequenceLabelProcessed.getTerm(i);
	...
	public ArrayList<Cluster> getSimilarClusterList(Entity entity, Sequence sequence) {
		...
		QuickSort.sort(((Double[]) invertedSimilarityList.toArray(new Double [invertedSimilarityList.size()])), similarClusterList);
	...
	public ArrayList<Cluster> getSimilarGeneralClusterList(Sequence sequence) {
		...
		QuickSort.sort(((Double[]) invertedSimilarityList.toArray(new Double [invertedSimilarityList.size()])), similarGeneralClusterList);
