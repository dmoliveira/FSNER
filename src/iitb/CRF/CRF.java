...
public class CRF implements Serializable {
    ...
    public transient ProbabilityInformationSet probabilityInformationSet;
    ...
    public CRF(int numLabels, FeatureGenerator fgen, String arg, Writer out) {
    ...
    public CRF(int numLabels, FeatureGenerator fgen, java.util.Properties configOptions, Writer out) {
        this(numLabels,1,fgen,configOptions);
        logOut = out;
    }
    
    public CRF(int numLabels, FeatureGenerator fgen, java.util.Properties configOptions, Writer out, double threshould) {
    	this(numLabels,1,fgen,configOptions);
    	probabilityInformationSet = new ProbabilityInformationSet(threshould);
    	logOut = out;
    }
    ...
    public CRF(int numLabels, int histsize, FeatureGenerator fgen, java.util.Properties configOptions, Writer out, double threshould) {
        this(numLabels, histsize, fgen, configOptions);
        probabilityInformationSet = new ProbabilityInformationSet(threshould);
        logOut = out;
    }
    ...
    protected Trainer getTrainer() {
        ...
        return new Trainer(params, logOut);
    }
    ...
    public void printPorcentageDivision() {
    	viterbi.printPorcentageDivision();
    }
};
