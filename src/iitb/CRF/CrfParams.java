...
public class CrfParams implements Serializable {
    ...
    */
    public double invSigmaSquare = 0.01;//0.01
    /** Maximum number of iterations over the training data during training */
    public int maxIters = 100;//100
    /** Convergence criteria for finding optimum lambda using BFGS */
    public double epsForConvergence = 0.001;//0.001
    /** The number of corrections used in the BFGS update. */
    public int mForHessian = 7;//7   

    public String trainerType = "";

    public int debugLvl = 1; // controls amount of status information output

    public boolean doScaling = true;//true

    public boolean doRobustScale = false;//false
    
    //-- Use the flag "reuseM true" if the edge features are independent
    // of i and x. This should certainly reduce the number of exp/log computations
    public boolean reuseM = false;//false
